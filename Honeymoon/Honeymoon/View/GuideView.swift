        ...
        ScrollView(.vertical, showsIndicators: false) {
            VStack(alignment: .center, spacing: 20) {
                ...
                VStack(alignment: .leading, spacing: 25) {
                    ...
                    GuideComponent(title: "Dismiss", subtitle: "Swipe left", description: "Would you rather skip this place? Touch the screen and swipe left. You wikk no longer see it.", icon: "xmark.circle")
